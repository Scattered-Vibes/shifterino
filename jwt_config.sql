...
COMMENT ON TABLE "public"."shift_options" IS 'Available shift time slots for scheduling';



COMMENT ON COLUMN "public"."shift_options"."shift_type" IS 'Category of shift (early, day, swing, graveyard)';



COMMENT ON COLUMN "public"."shift_options"."start_time" IS 'Start time of the shift in 24-hour format';



COMMENT ON COLUMN "public"."shift_options"."end_time" IS 'End time of the shift in 24-hour format';



COMMENT ON COLUMN "public"."shift_options"."duration_hours" IS 'Length of shift in hours (4, 10, or 12)';
...
CREATE INDEX "idx_shift_options_type" ON "public"."shift_options" USING "btree" ("shift_type");
